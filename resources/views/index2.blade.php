                ...
                <main>
                    ...
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                        <div class="container px-5">
                            ...
                            <a class="navbar-brand text-dark" href="index.html">PARTS TRADE 24 GmbH</a>
                    ...
                    <!-- Page Header-->
                    <header class="page-header-ui page-header-ui-dark bg-white bg-img-no-repeat " style="background-image: url('assets/img/backgrounds/background.jpg')">
                        <div class="page-header-ui-content">
                            <div class="container px-5">
                                <div class="row gx-5 align-items-center">
                                    <div class="col-lg-6">
                                        <div class="badge badge-marketing rounded-pill bg-secondary-soft text-secondary mb-3">Start today!</div>
                                        <h1 class="page-header-ui-title">Werden Sie ein Teil des Teams</h1>
                                                ...
                                                <form>
                                                    <div class="row gx-5 mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input class="form-control" id="leadCapFirstName" type="text" />
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="small text-gray-600" for="leadCapLastName">Last Name</label>
                                                            <input class="form-control" id="leadCapLastName" type="text" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="small text-gray-600" for="leadCapEmail">Email address</label>
                                                        <input class="form-control" id="leadCapEmail" type="email" />
                                                    </div>
                                                    <div class="mb-4">
                                                        <label class="small text-gray-600" for="leadCapCompany">Company or Organization</label>
                                                        <input class="form-control" id="leadCapCompany" type="text" />
                                                    </div>
                                                    <div class="d-grid"><button class="btn btn-primary fw-500" type="submit">Download Now</button></div>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="container px-5">
                            ...
                            <div class="row gx-5 mb-n10 z-1">
                                <div class="col-lg-6 mb-5">
                                    <div class="card h-100">
                                        <div class="card-body p-5">
                                            <div class="icon-stack icon-stack-xl bg-secondary-soft text-secondary mb-4"><i data-feather="users"></i></div>
                                ...
                                <div class="col-lg-6 mb-5">
                                    <div class="card h-100">
                                        <div class="card-body p-5">
                                            <div class="icon-stack icon-stack-xl bg-success-soft text-success mb-4"><i data-feather="trending-up"></i></div>
                                ...
                                <div class="col-lg-6 mb-5 mb-lg-0">
                                    <div class="card h-100">
                                        <div class="card-body p-5">
                                            <div class="icon-stack icon-stack-xl bg-primary-soft text-primary mb-4"><i data-feather="tool"></i></div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card h-100">
                                        <div class="card-body p-5">
                                            <div class="icon-stack icon-stack-xl bg-warning-soft text-warning mb-4"><i data-feather="layout"></i></div>
                        ...
                        <div class="container px-5">
                            <div class="row gx-5 align-items-center">
                                ...
                                <div class="col-lg-6 text-lg-end">
                                    <a class="btn btn-primary fw-500 me-2" href="#!">Start Now</a>
